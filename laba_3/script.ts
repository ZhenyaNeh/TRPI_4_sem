...
const arr: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 0, 3, 3];
...
//-Task_3
//
function rotateRight(arr: number[], roat: number): number[] {
...
//-Task_4
//
function mergeSortArrays(arr1: number [], arr2: number []){
    const merged: number [] = [...arr1, ...arr2];
    
    return merged.sort((a,b) => a - b);
}

function searchMedian(arr1: number [], arr2: number []): number {
    const arrForMedian: number [] = mergeSortArrays(arr1, arr2);
