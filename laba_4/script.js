...
//
class ProductInfo {
    constructor(number, size, color, price) {
        this.number = number;
        this.size = size;
        this.color = color;
        this.price = price;
...
console.log("\nEnd....\n");
function filterFunc(minPrice, maxPrice, targetSize, targetColor) {
...
class NewProductInfo {
    constructor(number, size, color, price, discount) {
        this.number = number;
        this.size = size;
        this.color = color;
        this.price = price;
...
function newItarationFunc(prod) {
